# 
# Project automation script for CTRL_iseproj 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source CTRL_iseproj.tcl), then you can
...
set myProject "CTRL_iseproj"
set myScript "CTRL_iseproj.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../ControllerFPGA_1.ucf"
   xfile add "../coregen/CMD_Fifo.xco"
   xfile add "../coregen/FEBIDListRam.xco"
   xfile add "../coregen/FIFO_DC_1kx16.xco"
   xfile add "../coregen/FIFO_SC_4Kx16.xco"
   xfile add "../coregen/GTPClkDCM.xco"
   xfile add "../coregen/GTPRxBuff.xco"
   xfile add "../coregen/LinkFIFO.xco"
   xfile add "../coregen/PLL_Buff.xco"
   xfile add "../coregen/SysPll.xco"
   xfile add "../coregen/TrigPktBuff.xco"
   xfile add "../coregen/gtp_xcvr.xco"
   xfile add "../rtl/Controller_FPGA1.vhd"
   xfile add "../rtl/FM_Tx_Rx.vhd"
   xfile add "../rtl/Project_Defs.vhd"
   xfile add "../rtl/crc.vhd"
   xfile add "../rtl/serdes_1_to_n_clk_ddr_s8_diff.vhd"
   xfile add "../rtl/serdes_1_to_n_data_ddr_s8_diff.vhd"
   xfile add "../sim/Controller_FPGA1_tb.vhd"
   puts ""
   puts "WARNING: project contains IP cores, synthesis will fail if any of the cores require regenerating."
   puts ""

   # Set the Top Module as well...
   project set top "behavioural" "ControllerFPGA_1"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/dmishins/DAPHNE/ctrtest/CTRL_iseproj/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "ControllerFPGA_1" -process "Generate IBIS Model"
